  ...
  return (
    <div className="tournament-preview-card">
      ...
      <div className="tournament-card-content">
        ...
        <h3 className="tournament-name">{name || "Tournament Name"}</h3>
        <p className="tournament-description">
          {description || "Tournament description will appear here..."}
        </p>

        <div className="tournament-details">
          <div className="detail-item">
            <Trophy size={16} />
            <span>Prize Pool: {prize_pool || "$0"}</span>
          </div>
          <div className="detail-item">
            <Calendar size={16} />
          ...
          <div className="detail-item">
            <Users size={16} />
            <span>Max Players: {max_players || "0"}</span>
          </div>
        </div>
        ...
        <div className="tournament-card-actions">
          ...
          {isRegistrationOpen && (
            <button className="tournament-join-btn">Join Tournament</button>
          )}
        </div>
      </div>
    </div>
